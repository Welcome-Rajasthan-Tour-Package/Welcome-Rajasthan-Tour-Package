...
const Privacy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy - Welcome Rajasthan Tour Package</title>
      </Helmet>
      <FrontView2
        pageName="Privacy"
        bgImg="bg-[url('./assets/privacy-bg.webp')]"
        position="bg-[0_40%]"
      />
      <main>
        <section className="page4 w-full flex items-center justify-center flex-col py-10 bg-[#eef3f7] bg-cover bg-center bg-fixed bg-no-repeat">
          ...
          <div className="container mt-5 mx-auto privacy-content text-sm md:text-base px-7 md:px-12 lg:px-16 xl:px-20 pb-7">
            <p>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Welcome
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Welcome Rajasthan Tour
                  ...
                  <a
                    ...
                    target="_blank"
                  >
                    https://www.welcomerajasthantourpackage.com
                  </a>
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p className="break-words">
                  ...
                  >
                    welcomerajasthantourpackage@gmail.com
                  </a>
                </p>
              </li>
              <li>
                <p>
                  <a className="text-theme-color" href="tel:+916376335095">
                    (+91)-6376335095
                  </a>
                </p>
              </li>
            ...
            <ul>
              <li>
                <p className="break-words text-theme-color">
                  By email:{" "}
                  <a href="mailto:welcomerajasthantourpackage@gmail.com">
                    welcomerajasthantourpackage@gmail.com
                  </a>
                </p>
              </li>
              <li>
                <p>
                  ...
                  <a
                    className="break-words text-theme-color"
                    href="https://www.welcomerajasthantourpackage.com"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
